...
#!/usr/bin/env python
"""
e2.py - Example python coding from Hacking
Description: Run arbitrary system command from python code from STDIN
...
if __name__ == "__main__":
    ...
    print 'Please enter system command'
    command_line = raw_input('ST2Labs> ')
